...
import { NavPrimary } from '@/components/ui/nav-primary'
          ...
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild>
              <Link to="/dashboard" className="flex items-center gap-3">
                <div className="bg-sidebar-primary text-sidebar-primary-foreground aspect-square size-8 flex-center rounded-lg">
